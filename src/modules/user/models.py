...
class User(Base):
    ...
    highest_level = Column("highest_level", Integer, ForeignKey("active_tower_runs"), unique=False)
    ...
    current_level = Column("current_level", Integer, ForeignKey("active_tower_runs"), nullable=False, unique=False)
